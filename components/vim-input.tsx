  ...
  return (
    <div className="w-full relative z-[110] flex flex-col items-center">
      ...
      >
        ...
        <AnimatePresence>
          {isCommandKOpen && (
            <motion.div
              ...
              className="absolute bottom-full left-0 right-0 w-full border-t border-border bg-background/95 backdrop-blur-3xl shadow-[0_-24px_60px_-12px_rgba(0,0,0,0.6)]"
            ...
            >
              ...
              <div className="flex items-center gap-3 px-5 py-3 border-b border-border">
                ...
                <input
                  ...
                  className="flex-1 bg-transparent font-mono text-xs text-foreground/70 placeholder:text-muted-foreground outline-none"
                />
                {search && (
                  <button
                    onClick={() => setSearch("")}
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="text-center leading-tight">
                              ...
                              {item.sub && <div className={`font-mono text-[7px] uppercase tracking-[0.15em] mt-0.5 ${focused ? "text-primary/60" : "text-muted-foreground/60"}`}>{item.sub}</div>}
                            </div>
                          </button>
                        )
                      })}
                      ...
                      {actionItems.map((item, i) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="text-center leading-tight">
                              <div className="font-mono text-[10px] font-bold tracking-tight">{item.label}</div>
                              <div className={`font-mono text-[7px] uppercase tracking-[0.15em] mt-0.5 ${focused ? "text-primary/60" : "text-muted-foreground/60"}`}>{item.sub}</div>
                            </div>
                          </button>
                        )
                      })}
              ...
              <div className="flex items-center justify-end gap-4 px-5 py-2 border-t border-border">
                {[
                  ...
                  <div key={key} className="flex items-center gap-1.5">
                    <kbd className="font-mono text-[9px] text-muted-foreground bg-muted/50 border border-border rounded px-1 py-0.5">{key}</kbd>
        ...
        {/* ── Main Input Bar ─────────────────────────────────────────────── */}
        <div className="w-full border-t border-border bg-background/95 backdrop-blur-3xl px-6 py-5 flex items-center gap-4 transition-all duration-300 focus-within:border-primary/40 relative">
          ...
          <div className="flex items-center gap-3 flex-1">
            ...
            <Command.Input
              ...
              className="flex-1 bg-transparent font-mono text-sm tracking-tight text-foreground outline-none placeholder:text-muted-foreground"
              autoFocus
            />
          </div>
